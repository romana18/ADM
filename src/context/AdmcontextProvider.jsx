...
function AdmcontextProvider({ children }) {
    ...
    return (
        <Admcontext.Provider value={{ specific, setSpecific,posts,user,prodname,prodlocation,prodprice,prodslife,dairyname,setProdname,FSSAI,setProdprice,setProdslife,setDairyname,prodquant,setFSSAI,setProdquant,setProdlocation,prodcreated, setProdcreated }}>
            {children}
        </Admcontext.Provider>
    );
}
